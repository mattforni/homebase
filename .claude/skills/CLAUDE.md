...
The `assist:*` skills live in the `local-skills` marketplace at `.claude/local-skills/plugins/assist/`. They are installed via `claude plugin install assist@local-skills`. See that directory for details.
