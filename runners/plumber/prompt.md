...
- The Atelic repo: the method at {{ATELIC}}/Pipeline/README.md and the three rules in Pipeline/CLAUDE.md, the voice samples in Pipeline/Voice/ and Brand/voice.md, last week's roster, and this week's skeleton at {{ATELIC}}/Pipeline/{{WEEK}}-roster.md with whatever sits under its `## Placed Ahead` heading. Any name with a folder under Leads/ or Customers/ has an audit there; read it before drafting for that name.
